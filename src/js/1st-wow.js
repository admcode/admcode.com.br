/*jshint asi:true, expr:true, laxbreak:true, laxcomma:true, loopfunc:true */
  ...
  this.WOW = function() {
        ...
        for (t = t.parentNode || t, o = t.querySelectorAll("." + this.config.boxClass), r = [], n = 0, i = o.length; n < i; n++)
          ...
          s.call(this.all, e) < 0
            ? (this.boxes.push(e), this.all.push(e), this.stopped || this.disabled()
              ? this.resetStyle()
              : this.applyStyle(e, !0), r.push(this.scrolled = !0))
            : r.push(void 0);
        return r
      }
    },
      ...
      for (n in e)
        ...
        i.push(function() {
          var e,
            ...
            s,
            l;
          for (s = this.vendors, l = [], e = 0, i = s.length; e < i; e++)
            r = s[e],
    ...
    o.prototype.vendorCSS = function(t, e) {
      var n,
        ...
        l,
        a;
      for (l = i(t), s = l.getPropertyCSSValue(e), r = this.vendors, n = 0, o = r.length; n < o; n++)
        a = r[n],
